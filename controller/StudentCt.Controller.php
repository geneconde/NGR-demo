...
require_once($_SERVER['DOCUMENT_ROOT'].'/shymansky/demo/includes/StudentCt.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].'/shymansky/demo/includes/StudentCtAnswer.class.php');
