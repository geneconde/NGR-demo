...
class DB extends PDO {
	...
	**/
	...
	protected $database = "jigzenco_demo_live";
	...
	public function getUID($UN) {
		$sql=mysql_query("select * from users where username='$UN' LIMIT 1") or die(mysql_error());
	    $row=mysql_fetch_assoc($sql);
	    return $row['user_ID'];
	}

	public function selectDistinct($table, $where="", $fields="*", $orderby="") {
		try {
