<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $sac->getStudentAnswer($_SESSION['smid'], 'gathering-data-qq3-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
<!DOCTYPE html>
...
<body>
			...
			<div id="question">
				...
				<section>
					...
					<form class="ac-custom ac-checkbox ac-checkmark" autocomplete="off">
						...
						<ul>
							<li><input id="r1" name="r1" type="checkbox"><label for="r1"><?php echo _('Four kids have dogs.'); ?></label></li>
							<li><input id="r2" name="r1" type="checkbox"><label class="r2" for="r2"><?php echo _('The number of kids who own dogs, cats, and turtles altogether are more than the number of kids who own fish and birds altogether.'); ?></label></li>
							<li><input id="r3" name="r1" type="checkbox"><label for="r3"><?php echo _('Only one kid has a turtle.'); ?></label></li>
							<li><input id="r4" name="r1" type="checkbox"><label class="r4" for="r4"><?php echo _('The number of kids who have dogs, is the same as the number of kids who have birds.'); ?></label></li>
							<li><input id="r5" name="r1" type="checkbox"><label class="r5" for="r5"><?php echo _('The number of kids who own cats is one more than the number of kids who own fish.'); ?></label></li>
						<ul>
	...
	function checkAnswers() {
		...
		if($('#r1').is(':checked') && $('#r3').is(':checked') && $('#r4').is(':checked') && !$('#r2').is(':checked') && !$('#r5').is(':checked') ) {
			textanswer1.append("<?php echo _('Four kids have dogs.'); ?></br>");
			textanswer1.append("<?php echo _('Only one kid has a turtle.'); ?></br>");	
			textanswer1.append("<?php echo _('The number of kids who have dogs, is the same as the number of kids who have birds.'); ?></br>");
			...
			if($('#r1').is(':checked')){
				...
				textanswer1.append("<?php echo _('The number of kids who own dogs, cats, and turtles altogether are more than the number of kids who own fish and birds altogether.'); ?></br>");
			} if ($('#r3').is(':checked')){
				textanswer1.append("<?php echo _('Only one kid has a turtle.'); ?></br>");	
			} if ($('#r4').is(':checked')){
				textanswer1.append("<?php echo _('The number of kids who have dogs, is the same as the number of kids who have birds.'); ?></br>");
			} if ($('#r5').is(':checked')){
				textanswer1.append("<?php echo _('The number of kids who own cats is one more than the number of kids who own fish.'); ?></br>");
			}
