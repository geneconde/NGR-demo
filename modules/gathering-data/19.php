<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $sac->getStudentAnswer($_SESSION['smid'], 'gathering-data-qq4-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
<!DOCTYPE html>
		...
		<div class="bg">
			<div id="question">
				...
				<form id="nl-form" class="nl-form">
					<p><?php echo _('One inch is a little bit more than 2 times a'); ?>
					<select id="opt1">
					...
					<p><?php echo _('One way to reduce the error in measurement is to make many measurements and'); ?>
					<select id="opt2">
						<option value="1" selected>&#60;<?php echo _('select'); ?>&#62;</option>
					...
					<p><?php echo _('1 ounce is about 28 times more than a'); ?>
					<select id="opt3">
						<option value="1" selected>&#60;<?php echo _('select'); ?>&#62;</option>
			...
			<div id="answer">
				...
				<p><?php echo _('One inch is a little bit more than 2 times a'); ?> <span id="ans1"> </span>. </p>
				<p><?php echo _('One way to reduce the error in measurement is to make many measurements and'); ?> <span id="ans2"> </span> <?php echo _('them.'); ?></p>
				<p><?php echo _('1 ounce is about 28 times more than a'); ?> <span id="ans3"> </span>.</p>
				<p><?php echo _('The term'); ?> <span id="ans4"> </span> <?php echo _('refers to information gathered through observation.'); ?></p>
