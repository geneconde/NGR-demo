<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $sac->getStudentAnswer($_SESSION['smid'], 'gathering-data-qq5-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
<!DOCTYPE html>
...
td { 
	...
	#chart_divD > div:nth-child(1) > div > div > svg, #chart_divE > div:nth-child(1) > div > div > svg, #chart_divF > div:nth-child(1) > div > div > svg {
		width: 360px;
	}
