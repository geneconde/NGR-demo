<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $sac->getStudentAnswer($_SESSION['smid'], 'solar-power-qq6-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
				...
				<div class="placeholder">
					...
					<form id="nl-form" class="nl-form">
						...
						<select id="opt1">
							...
							<option value="A"><?php echo _("condense"); ?></option>
							<option value="B"><?php echo _("radiate"); ?></option>
							<option value="C"><?php echo _("precipitate"); ?></option>
							<option value="D"><?php echo _("evaporate"); ?></option>
						</select>
		...
		check.click(function(e){
			...
			if(nullAnswer == true) {
				...
				question.fadeOut(function(){ 
					...
					if(answered == 0) {
						saveAnswer('solar-power-qq6-a', answer1);
						answered = 1;
					} // end save to db
