<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $sac->getStudentAnswer($_SESSION['smid'], 'solar-power-qc2-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
				...
				<div class="placeholder">
					...
					<div id="question2">
						...
						<div id="choices2">
							...
							<label for="b1" class="css-label"><?php echo _("The sun damages life on earth."); ?></label><br>
							<input type="radio" id="b2" name="q2" class="css-radio">
							<label for="b2" class="css-label"><?php echo _("The sun powers life on earth."); ?></label><br>
							<input type="radio" id="b3" name="q2" class="css-radio">
							<label for="b3" class="css-label"><?php echo _("The sun protects life on earth."); ?></label><br>
							<input type="radio" id="b4" name="q2" class="css-radio">
							<label for="b4" class="css-label"><?php echo _("All of the above"); ?></label>
						</div>
					</div>
				</div>
			</div>
		...
		check.click(function(e){
			...
			if(nullAnswer == true) {
				...
				question.fadeOut(function(){ 
					...
					if($('#b2').is(':checked')) {
						textanswer2.text("<?php echo _('The sun powers life on earth.'); ?>");
