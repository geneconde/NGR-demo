...
function PDF($orientation='P', $unit='mm', $format='A4')
{
    ...
    $this->fontlist=array("arial","times","courier","helvetica","symbol","aealarabiya");
...
function Header() {
            ...
            // $this->image(dirname(__FILE__).'/../images/logo2.png', 100, 5, 50);
            // $this->Ln(25);
    $this->image(dirname(__FILE__).'/../images/logo3.png', 0, 0, 210);
    $this->Ln(25);
        }
function Footer()
{
