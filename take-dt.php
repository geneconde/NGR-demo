...
<p><?php echo _("This pre-diagnostic test consists of"); ?> <strong><?php echo $count; ?> <?php echo _("questions"); ?></strong> <?php echo _("from the"); ?> <strong><?php /*echo $module_set->getModule_name();*/  echo _($module_name);?></strong> <?php echo _("module. You have"); ?> <strong> <?php echo $timelimit; ?> <?php echo _("minutes"); ?></strong> <?php echo _(" to answer all these questions. <strong>The timer</strong> will start <strong>running</strong> as soon as you click the <strong>Start Test</strong> button below. Before clicking <strong>Finish</strong> at the end of the test and if you still have time, you can review all your answers by clicking the <strong>Back</strong> and <strong>Next</strong> buttons at the bottom of the page. Only the answers that are completed within the time limit will be recorded."); ?></p>
<?php } else { ?>
<h1><?php /*echo $module_set->getModule_name();*/  echo _($module_name);?> - <?php echo _("Post-Diagnostic Test"); ?></h1>
<p><?php echo _("This post diagnostic test consists of"); ?> <strong><?php echo $count; ?> <?php echo _("questions"); ?></strong> <?php echo _("from the"); ?> <strong><?php /*echo $module_set->getModule_name();*/  echo _($module_name);?></strong> <?php echo _("module. You have"); ?> <strong> <?php echo $timelimit; ?> <?php echo _("minutes"); ?></strong> <?php echo _(" to answer all these questions. <strong>The timer</strong> will start <strong>running</strong> as soon as you click the <strong>Start Test</strong> button below. Before clicking <strong>Finish</strong> at the end of the test and if you still have time, you can review all your answers by clicking the <strong>Back</strong> and <strong>Next</strong> buttons at the bottom of the page. Only the answers that are completed within the time limit will be recorded."); ?></p>
<?php } ?>
<br/><br/><br/><br/>
<div class="center">
